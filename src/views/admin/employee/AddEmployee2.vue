...
<!--                <el-option label="区域二" value="beijing"></el-option>-->
        ...
        <el-form-item label="签约时间" required>
            <el-col :span="11">
                <el-form-item prop="signDateStr">
                    <el-date-picker type="date" placeholder="选择签约日期" v-model="ruleForm.signDateStr" style="width: 100%;"></el-date-picker>
                </el-form-item>
            </el-col>
            <el-col class="line" :span="2">-</el-col>
            <el-col :span="11">
                <el-form-item prop="overDateStr">
                    <el-date-picker type="date"  placeholder="选择终止日期" v-model="ruleForm.overDateStr" style="width: 100%;"></el-date-picker>
                </el-form-item>
            </el-col>
        </el-form-item>
        <el-form-item>
