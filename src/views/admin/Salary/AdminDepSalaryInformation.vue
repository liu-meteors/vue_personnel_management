    ...
    export default {
        ...
        methods: {
            ...
            handleClick(tab, event) {
                const me=this
                if (tab.name=='first'){
                    me.getDepMonthSalary(sessionStorage.getItem('dep'))
                }else {
                    me.getDepAllSalary(sessionStorage.getItem('dep'))
                }
            },
            filterPos(value, row) {
            ...
            getDepMonthSalary(dep){
                const me=this
                axios.get('http://localhost:8181/getSalaryByDepNow/'+dep).then(function (resp) {
                    console.log(resp)
            ...
            getDepAllSalary(dep){
                const me=this
                axios.get('http://localhost:8181/getAllDepSalary/'+dep).then(function (resp) {
                    console.log(resp)
                    me.tableData=resp.data
                })
            },
